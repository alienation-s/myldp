...
def compare_experiments(file_path, output_dir, target):
    ...
    if target == "e":
        ...
        results = []
        for e in es:
            result_budget = run_experiment(file_path, output_dir, sample_fraction=1.0, total_budget=e, w=160, DTW_MRE=True)
        ...
        results = []
        for w in ws:
            result_window = run_experiment(file_path, output_dir, sample_fraction=1.0, total_budget=1.0, w=w, DTW_MRE=True)
